...
!!! example  
    ...
    1,1-0:1.8.0*255(@2000,Energieexport,kWh,ExportActive,3`
    ```
    ...
    COUNTER: `+1,12,c,1,-30,DRS155`<BR>
    `1,1-0:1.8.0*255(@2000` prints the energy on a power meter using 2000 impulses for 1 kWh
